...
class Node:
    def __init__(self, points, splitdim=0, distribution=-1):
        """Arguments:
...
if __name__ == '__main__':
    ...
    # node2 = Node((2, 3), None)
    tree.set([(1, 1), (5, 5), (4, 4), (10, 10), (0, 0), (11, 11)], [(1, 0)] * 6)
    ...
    print("neighbors after iteration1 are: ", neighbors)
    tree.add((2, 3), 'f')
    neighbors2 = tree.neighbors((1, 1), 10)
    print("neighbors after iteration2 are: ", neighbors2)
